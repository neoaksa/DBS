...
public class UserResource extends ServerResource {
	...
	public void doInit() {
		...
		Key<RegistrationInfo> theKey = Key.create(RegistrationInfo.class, widgetid);
	...
	public Representation get(Variant variant) throws ResourceException {
		...
		if (null == this.widget) {
			...
			getResponse().setStatus(Status.CLIENT_ERROR_NOT_FOUND); // set response not scuccessful
